...
def import_csv():
    with open('./data/hm3d/video_statistics.csv', 'r') as csv_file:
...
def plot_video_length_histogram(csv, filename='video_length_histogram.svg'):
    ...
    plt.title('Video Length Histogram')
...
def plot_number_of_frames_histogram(csv, filename='number_of_frames_histogram.svg'):
...
def plot_visited_rooms_bar(csv, filename='visited_rooms_bar.svg'):
    ...
    plt.ylabel('Frequency')
    plt.title('Visited Rooms Bar Graph')
...
def plot_moved_floors_bar(csv, filename='moved_floors_bar.svg'):
    ...
    plt.ylabel('Frequency')
    plt.title('Moved Floors Bar Graph')
