...
class Inspection:
    ...
    def draw_pie_chart(self, data, filename):
    ...
    def draw_bar(self, data, filename):
    ...
    def questions_by_category(self):
        ...
        self.draw_pie_chart(category_counts, "questions_by_category.png")
    ...
    def do_extra_answers_exist(self):
        ...
        self.draw_pie_chart(has_extra_answers, "extra_answers_exist.png")

        # Draw a pie chart (Do extra answers exist in Object Localization)
        self.draw_pie_chart(has_extra_answers_ol, "extra_answers_exist_ol.png")
    ...
    def which_episodes_were_used(self):
        ...
        self.draw_bar(used_episodes, "which_episodes_were_used.png")
